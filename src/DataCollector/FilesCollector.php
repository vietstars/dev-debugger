...
namespace Vietstars\DevDebugger\DataCollector;

use Vietstars\DevDebugger\DataCollector;
use Vietstars\DevDebugger\Renderable;
        ...
        foreach ($files as $file) {
            ...
            if (
                strpos($file, 'vendor/maximebf/debugbar/src') !== false || strpos(
                    $file,
                    'vendor/vietstars/dev-debugger/src'
                ) !== false
            ) {
                continue;
